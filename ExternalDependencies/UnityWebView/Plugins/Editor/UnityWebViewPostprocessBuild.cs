    ...
    public void OnPreprocessBuild(BuildTarget buildTarget, string path) {
        if (buildTarget == BuildTarget.Android) {
            ...
            if (!File.Exists(dev) || !File.Exists(rel)) {
                dev = "Assets/Plugins/Privy/ExternalDependencies/UnityWebView/Plugins/Android/WebViewPlugin-development.aar.tmpl";
                rel = "Assets/Plugins/Privy/ExternalDependencies/UnityWebView/Plugins/Android/WebViewPlugin-release.aar.tmpl";
            }
